                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"
                                    style="overflow: hidden; text-overflow: ellipsis;display: -webkit-box;-webkit-line-clamp: 6; line-clamp: 6; -webkit-box-orient: vertical;">
                                    <?php echo $rnews['berita']?></p>
                                <a href="<?php echo $rnews['link']?>" class="btn btn-outline-success btn-sm">Read
                                    More</a>
                            </div>
                        </div>
                    </div>
